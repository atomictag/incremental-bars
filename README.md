...
```javascript
var tmpl1   = '<div class="A B C" style="color:red">FIRST TEMPLATE</div>'
var tmpl2   = '<div class="C B A" style="color:blue">SECOND TEMPLATE</div>'
var statics = {};
...
and code generated by the respective templates references __$._1, __$._2 and __$._3 instead of the original strings.
(__$ is the actual name of the variable that needs to be used when dumping the statics object into a variable. This can be changed with the *secret* option "staticsName")
