(function(Hbs, Idom) {
  ...
  return (_o("div", "idom-2", __$._1614377996) , _t("\n") , _o("h3", "idom-3", null) , _t("Simple template") , _c("h3") , _t("\n") , _o("div", "idom-4", null) , _t("\n") , _o("strong", "idom-5", null) , _t("Hello "
    ...
    + "") , _c("strong") , _t("\n") , _c("div") , _t("\n") , _o("div", "idom-6", null) , _t("\n") , _o("p", "idom-7", null) , _t("The simplest template ever!") , _v("br", "idom-8", null) , _t("Feel free to modify the file ") , _o("code", "idom-9", null) , _t("templates/template.html") , _c("code") , _t(" and experiment.") , _c("p") , _t("\n") , _o("p", "idom-10", null) , _t("After you modify the template, run again the ") , _o("code", "idom-11", null) , _t("node build.js") , _c("code") , _t(" script and reload the page.") , _c("p") , _t("\n") , _c("div") , _t("\n") , _c("div") , _t("\n") , _v("hr", "idom-12", null));
},"useData":true});
